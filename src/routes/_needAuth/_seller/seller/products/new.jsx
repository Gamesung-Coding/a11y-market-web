...
function SellerProductNewPage() {
  ...
  return (
    ...
    >
      ...
      >
        <h1 className='font-kakao-big text-xl font-semibold'>상품 등록</h1>
        <p className='mt-1 text-xs text-gray-500'>새로운 상품을 등록하고 판매를 시작하세요.</p>
      </header>
...
export const Route = createFileRoute('/_needAuth/_seller/seller/products/new')({
